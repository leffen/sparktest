...
describe("TrendChart", () => {
  ...
  it("renders without crashing", () => {
    const { getByTestId } = render(<TrendChart data={mockData} color="#ff0000" />)
  ...
  it("passes correct props to Area component", () => {
    const color = "#00ff00"
    const { getByTestId } = render(<TrendChart data={mockData} color={color} />)
  ...
  it("handles empty data array", () => {
    const { getByTestId } = render(<TrendChart data={[]} color="#0000ff" />)
